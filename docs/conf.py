...
latex_documents = [
    ("index", "Envelopes.tex", u"Envelopes Documentation", u"Tomasz Wójcik", "manual")
]
...
man_pages = [("index", "envelopes", u"Envelopes Documentation", [u"Tomasz Wójcik"], 1)]
